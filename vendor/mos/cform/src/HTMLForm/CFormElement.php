...
class CFormElement implements \ArrayAccess
{
    ...
    public function getHTML()
    {
		...
		$onclick	  =	isset($this['onclick']) && $this['onclick'] ? " onclick='{$this['onclick']}'" : null;
		$novalidate	  = isset($this['novalidate']) && $this['novalidate'] ? " formnovalidate='formnovalidate'" : null;
        ...
        if (in_array($this['type'], ['submit', 'reset', 'button'])) {
            ...
            return "<span><input id='$id'{$type}{$class}{$name}{$value}{$autofocus}{$readonly}{$title}{$onclick}{$novalidate} /></span>\n";
